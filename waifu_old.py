...
def cleanup():
    ...
    os.system("del response.wav")
    os.system("del waifu.mp4")
...
def waifu_query(query, user_id, user_name, server_name, channel_name):
    ...
    'X-RapidAPI-Key': '029de3eee0mshf9b9b932c47c3e8p1d8e43jsnfcbd96edeb75'
    }
...
async def on_message(msg):
    ...
    if msg.content.startswith('!waifu '):
        query = re.sub('!waifu ', '', msg.content)
...
client.run('OTQxNDAxNzE4NzAzNDE1MzE2.YgVarA.VMUyVLn8qywsxK7mTrAWBSlJih4')
